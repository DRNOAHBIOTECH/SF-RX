#!/usr/bin/env python3
"""
Train a GAT model on the DDI dataset
"""
...
def main():
    ...
    from models.GNN import GATV2, FlexibleLitGNNModel
    ...
    NUM_EDGE_FEATURES = 0
    LOG_PATH = f"GAT_LOG/logs_{args.split_level}_split"
