#!/usr/bin/env python3
"""
Train a GCN-Transformer model on the DDI dataset
"""
...
def main():
    ...
    from models.Transfomer import GCNTransformer
    ...
    LOG_PATH = f"GCN_Transformer_LOG/logs_{args.split_level}_split"
    ...
    for fold_idx in FOLDS:
        model = GCNTransformer(
            ...
            hidden_channels=NUM_NODE_FEATURES * args.expand_factor,
