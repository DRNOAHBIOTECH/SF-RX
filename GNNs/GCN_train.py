#!/usr/bin/env python3
"""
Train a GCN model on the DDI dataset
"""
...
def main():
    ...
    from models.GNN import GCN, FlexibleLitGNNModel
    ...
    NUM_EDGE_FEATURES = 0
    LOG_PATH = f"GCN_LOG/logs_{args.split_level}_split"
    ...
    for fold_idx in FOLDS:
        model = GCN(in_channels=NUM_FEATURES, 
                    hidden_channels=NUM_FEATURES * args.expand_factor,
