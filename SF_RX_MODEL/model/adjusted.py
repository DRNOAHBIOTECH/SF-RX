...
class LitMultiOuputModel(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_severity = nn.CrossEntropyLoss()(pred_severity, y_severity)
        loss_desc = nn.CrossEntropyLoss()(pred_desc, y_desc)
        loss_direc = nn.CrossEntropyLoss()(pred_direc, y_direc)
